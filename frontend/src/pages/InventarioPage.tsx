...
<<<<<<< HEAD
      ...
      setError(err.response?.data?.detail || err.message || 'Error al cargar catálogos del inventario.');
    }
  };
      ...
      {activeTab === 'cuentas' && (
        <div className="flex justify-end">
          <Button 
            ...
            className="bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold px-5 py-2.5 rounded-xl text-xs flex items-center gap-1.5 cursor-pointer shadow-lg shadow-cyan-500/10"
          >
